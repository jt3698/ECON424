...
From 1269 variables, we have 674 variables in our model with interactions. Below is the intercept of the model, the top 10 variables that positively affect revenue, and the top 10 variables that negatively affect revenue.
...
1920s
We see that in the 1920s, the strongest indicators that a movie is successful are 'music', 'world war 1', 'based_on_novel_or_book' 'charles_chaplin_productions'. Movies about World War 1 is a particularly interesting one because it would be then that movies were being made about the war that just ended about a decade prior, and it was a popular sub-genre.
...
1. Most production companies affect the revenue positively, while some of the non-popular languages and genres affect the revenue negatively, something like that.

2. In our analysis of the model with interactions, we could not find a satisfactory generalized conclusion. However, we did find a few interesting interactions which suggested some aspects that are open for moviemakers to interpret and discuss further.

3. Do people’s preferences for movie genres and actors change over the years/decades?
