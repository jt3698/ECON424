...
```{r}
clean_data <- data[data$revenue > 0, !names(data) %in% c("overview", "popularity","vote_average","vote_count","poster_path","backdrop_path","recommendations")]
...
```{r}
clean_data <- clean_data[clean_data$runtime > 40,]
